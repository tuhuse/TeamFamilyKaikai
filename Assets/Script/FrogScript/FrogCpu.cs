...
public class FrogCpu : MonoBehaviour {
 ...
 　 private bool _isAlive;
    ...
    void Start() {
        ...
        _cpuNumber = _select._enemyNumber;
        if (_cpuNumber== 0) {
            _difficultynumber = Difficultys.easy;
        } else if (_cpuNumber == 1) {
            _difficultynumber = Difficultys.nomal;
        } else if (_cpuNumber == 2) {
    ...
    void Update() {
        ...
        if (_isAlive) {
            ...
            RankingCalculation();//ランキング計算
            BeardAttack(); //アイテム使用
            WaterBall();
            MucusAttack();
            UseAbility();
            ModeCpu(); //難易度
            Ranking();//ランキング難易度とアイテムレア度変更
            #endregion
            //アニメーション
    ...
    private void RankingCalculation() {
    ...
    private void EnemyJump() {
        ...
        switch (_swicthRandomJump) {
            case SwicthRandomJump.LoseJump:
    ...
    private void Ranking() {
        switch (_rank) {
            case Rank.One:
                ...
                _swicthRandomJump = SwicthRandomJump.WinJump;
                break;
            case Rank.Two:
            ...
            case Rank.Four:
                ...
                _swicthRandomJump = SwicthRandomJump.LoseJump;
                break;
